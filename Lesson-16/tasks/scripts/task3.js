...
class Company {
  constructor(initName, initMonth, initYear, servisesList, branchesList) {
    this.name = initName
    this.date = {
      month: initMonth,
      year: initYear
    }
    this.services = servisesList
...
const servisesList = [
  new Service("Website", 10000, 15),
  new Service("Project", 5000, 5),
  new Service("Mobile_App", 20000, 30),
]

const branchesList = [
  new Branches('Ukraine', 'Kyiv', 'Prakhovy family', 54),
  new Branches('Ukraine', 'Vinnytsia', 'Polytechnic', 2),
  new Branches('Ukraine', 'Vinnytsia', 'Ovodova', 21),
  new Branches('Ukraine', 'Chernivtsi', 'Heroiv of Maidan', 150),
  new Branches('USA', 'Newtown', 'University Drive', 41),
]

const company = new Company('EPAM Systems', 7, 1993, servisesList, branchesList)
